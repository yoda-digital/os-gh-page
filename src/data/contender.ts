...
contenderCopy.en = {
  ...
  builtBy: {
    ...
    yodaRole:
      "Yoda Digital — an AI-native and web studio in Chișinău, working since 2015, that builds and maintains the infrastructure, architecture and code behind major Moldovan media: TVR Moldova, jurnal.md, jurnaltv.md and unimedia.info. That experience shaped CONTender's guiding principle: deterministic checks are law, AI only assists, and the human decides. It is why the integrity score is computed reproducibly, and why the open-source ansc-mcp-server and mtender-mcp-server keep the data layer auditable, reusable and transparent.",
    esemplaRole:
